...
private _action = ["Cratefiller", localize "STR_KP_CRATEFILLER_TITLE", "KPGUI\res\kp512_CA.paa", {[_this] call KP_fnc_cratefiller_openDialog;}, {true}] call ace_interact_menu_fnc_createAction;
