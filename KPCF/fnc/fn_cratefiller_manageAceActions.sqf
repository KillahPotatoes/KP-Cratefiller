...
private _action = ["Cratefiller", localize "STR_KP_CRATEFILLER_TITLE", "KPGUI\res\kplogo_ca.paa", {[_this] call KP_fnc_cratefiller_openDialog;}, {true}] call ace_interact_menu_fnc_createAction;
